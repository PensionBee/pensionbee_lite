...
import { type AllowedCustomers, type RouteDefinitionRequest } from "@/server/shared/interface/routeDefinitions/requests";
import {
...
} from "@/server/shared/interface/routeDefinitions/responses";
