...
import accountData from '@/server/models/account';
import type AccountModel from '@/server/models/accountModel.types';
import {
    parseAccount,
    parseNewAccount,
    type Account,
    type NewAccount,
} from "@/server/contexts/accountManagement/core/entities/account.entity"
