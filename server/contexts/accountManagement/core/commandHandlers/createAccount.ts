...
import { createCommandHandler } from "@/server/shared/core/commands/commandHandling";
import { accountSchema } from "@/server/contexts/accountManagement/core/entities/account.entity";
...
} from "@/server/contexts/accountManagement/core/entities/account.events";
import { throwOnDefaultCase } from "@/server/shared/common/typeUtils";
import { AccountRepository } from "@/server/contexts/accountManagement/infra/accountRepository";
import { queryAccountByEmail } from "@/server/contexts/accountManagement/core/queryHandlers/queryAccountByEmail";
